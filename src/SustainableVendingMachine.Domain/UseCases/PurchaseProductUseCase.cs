...
namespace SustainableVendingMachine.Domain.UseCases
{
    public class PurchaseProductUseCase
    {
        ...
        public PurchaseProductResult PurchaseProduct(Product product)
        {
            ...
            {
                return new PurchaseProductResult("Insufficient amount", product, PurchaseFailedType.InsufficientCoins);
            }
            ...
            if (suffienctCoins)
            {
                ...
                return new PurchaseProductResult($"Thank you", product, coinsReturned);
            }
